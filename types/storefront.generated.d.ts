...
export type CreateCheckoutMutation = { checkoutCreate?: StorefrontTypes.Maybe<{ checkout?: StorefrontTypes.Maybe<Pick<StorefrontTypes.Checkout, 'id'>>, checkoutUserErrors: Array<Pick<StorefrontTypes.CheckoutUserError, 'field' | 'message'>> }> };
